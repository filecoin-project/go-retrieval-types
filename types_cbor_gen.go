...
func (t *Query) MarshalCBOR(w io.Writer) error {
	...
	// t.QueryParams (retrievaltypes.QueryParams) (struct)
...
func (t *QueryResponse) MarshalCBOR(w io.Writer) error {
	...
	// t.Status (retrievaltypes.QueryResponseStatus) (uint64)
	...
	// t.PieceCIDFound (retrievaltypes.QueryItemStatus) (uint64)
...
func (t *DealProposal) MarshalCBOR(w io.Writer) error {
	...
	// t.ID (retrievaltypes.DealID) (uint64)
	...
	// t.Params (retrievaltypes.Params) (struct)
...
func (t *DealResponse) MarshalCBOR(w io.Writer) error {
	...
	// t.Status (retrievaltypes.DealStatus) (uint64)
	if len("Status") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"Status\" was too long")
	}
...
func (t *Params) MarshalCBOR(w io.Writer) error {
	...
	// t.Selector (retrievaltypes.CborGenCompatibleNode) (struct)
